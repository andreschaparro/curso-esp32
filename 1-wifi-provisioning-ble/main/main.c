...
// Los siguientes 2 defines estan hardcodeados pero no deberian estarlo para produccion
...
static const char *TAG = "wifi-provisioning-ble";
...
void app_main(void)
{
    ...
    if (!provisioned)
    {
        ...
        // username y pop para generar el QR junto al service_name
